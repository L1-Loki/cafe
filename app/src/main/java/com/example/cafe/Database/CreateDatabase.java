...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public CreateDatabase(Context context) {
        super(context, "TheCafeDB", null, 1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tblNHANVIEN = "CREATE TABLE " + TBL_NHANVIEN + " ( " +
                ...
                + TBL_NHANVIEN_HOTENNV + " TEXT, " + TBL_NHANVIEN_TENDN
                + " TEXT, " + TBL_NHANVIEN_MATKHAU + " TEXT, "
                + TBL_NHANVIEN_EMAIL + " TEXT, " + TBL_NHANVIEN_SDT
                + " TEXT, " + TBL_NHANVIEN_GIOITINH + " TEXT, "
                + TBL_NHANVIEN_NGAYSINH + " TEXT , "
                + TBL_NHANVIEN_MAQUYEN + " INTEGER)";

        //Bảng quyền
        String tblQUYEN = "CREATE TABLE " + TBL_QUYEN + " ( "
                + TBL_QUYEN_MAQUYEN + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_QUYEN_TENQUYEN + " TEXT)";

        //Bảng bàn
        String tblBAN = "CREATE TABLE " + TBL_BAN + " ( "
                + TBL_BAN_MABAN + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_BAN_TENBAN + " TEXT, " + TBL_BAN_TINHTRANG + " TEXT )";

        //Bảng món
        String tblMON = "CREATE TABLE " + TBL_MON + " ( "
                + TBL_MON_MAMON + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_MON_TENMON + " TEXT, " + TBL_MON_GIATIEN + " TEXT, "
                + TBL_MON_TINHTRANG + " TEXT, " + TBL_MON_HINHANH
                + " BLOB, " + TBL_MON_MALOAI + " INTEGER )";

        //Bảng loại món
        String tblLOAIMON = "CREATE TABLE " + TBL_LOAIMON
                + " ( " + TBL_LOAIMON_MALOAI + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_LOAIMON_HINHANH + " BLOB, " + TBL_LOAIMON_TENLOAI + " TEXT)";

        //Bảng hóa đơn
        String tblDONDAT = "CREATE TABLE " + TBL_DONDAT + " ( "
                + TBL_DONDAT_MADONDAT + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TBL_DONDAT_MABAN + " INTEGER, " + TBL_DONDAT_MANV
                + " INTEGER, " + TBL_DONDAT_NGAYDAT + " TEXT, " + TBL_DONDAT_TONGTIEN
                + " TEXT," + TBL_DONDAT_TINHTRANG + " TEXT )";

        //Bảng chi tiết hóa đơn
        String tblCHITIETDONDAT = "CREATE TABLE " + TBL_CHITIETDONDAT
                + " ( " + TBL_CHITIETDONDAT_MADONDAT + " INTEGER, "
                + TBL_CHITIETDONDAT_MAMON + " INTEGER, "
                + TBL_CHITIETDONDAT_SOLUONG + " INTEGER, "
                + " PRIMARY KEY ( " + TBL_CHITIETDONDAT_MADONDAT
                + "," + TBL_CHITIETDONDAT_MAMON + "))";

        //String addAdmin="insert into NHANVIEN values('admin','admin','123456','admin@mail.mail','123456789','Nam','01/01/1996',0)";
...
//
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_HOTENNV,"admin");
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_TENDN,"admin");
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_MATKHAU,"123456");
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_EMAIL,"admin@gmail.com");
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_SDT,"1234567890");
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_GIOITINH,"Nam");
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_NGAYSINH,"01/01/2000");
//        contentValues.put(CreateDatabase.TBL_NHANVIEN_MAQUYEN,1);
//
//        db.insert(CreateDatabase.TBL_NHANVIEN,null,contentValues);
