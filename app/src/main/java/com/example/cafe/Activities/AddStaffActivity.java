...
import com.example.cafe.DAO.StaffDAO;
...
public class AddStaffActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_addstaff_ThemNV) {
            ...
            int gioiTinhId = RG_addstaff_GioiTinh.getCheckedRadioButtonId();
            if (gioiTinhId == R.id.rd_addstaff_Nam) {
                gioiTinh = "Nam";
            } else if (gioiTinhId == R.id.rd_addstaff_Nu) {
                gioiTinh = "Nữ";
            } else if (gioiTinhId == R.id.rd_addstaff_Khac) {
                gioiTinh = "Khác";
            }

            int quyenId = rg_addstaff_Quyen.getCheckedRadioButtonId();
            if (quyenId == R.id.rd_addstaff_QuanLy) {
                quyen = 1;
            } else if (quyenId == R.id.rd_addstaff_NhanVien) {
                quyen = 2;
            }
