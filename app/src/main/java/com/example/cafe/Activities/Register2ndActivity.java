...
import com.example.cafe.DAO.PermissionDAO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN_signup_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int checkedRadioButtonId = RG_signup_GioiTinh.getCheckedRadioButtonId();
                if (checkedRadioButtonId == R.id.rd_signup_Nam) {
                    gioiTinh = "Nam";
                } else if (checkedRadioButtonId == R.id.rd_signup_Nu) {
                    gioiTinh = "Nữ";
                } else if (checkedRadioButtonId == R.id.rd_signup_Khac) {
                    gioiTinh = "Khác";
                }
